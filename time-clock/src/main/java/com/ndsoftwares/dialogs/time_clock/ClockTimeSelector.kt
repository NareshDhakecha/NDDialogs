...
internal class ClockTimeSelector(
    ...
    private val textActiveColor =
        colorOfAttrs(ctx, R.attr.ndDialogValueTextActiveColor).takeUnlessNotResolved()
            ?: primaryColor
    ...
    init {
        ...
        with(bindingSelector) {
            ...
            numericalInput.setRightImageDrawable(R.drawable.nddialog_ic_arrow_right)

            numericalInput.leftImageListener { reduceIndex() }
            numericalInput.setLeftImageDrawable(R.drawable.nddialog_ic_arrow_left)
