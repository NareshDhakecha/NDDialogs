...
//            disableTimeline(TimeLine.PAST)
    ...
    private fun showOptionsSheetGridVertical() {
        ...
        NDOptionsDialog().show(this) { // Build and show
            ...
            with( // Add options
                Option(
                    R.drawable.nddialog_ic_color_picker,
                    "Edit"
                ).disable(), // An option can be disabled
                Option(
                    R.drawable.nddialog_ic_color_picker,
                ...
                Option(R.drawable.nddialog_ic_color_picker, "Duplicate")
            )
            onDismiss {
            }
        }
...
//        AppCompatDelegate.setDefaultNightMode(AppCompatDelegate.MODE_NIGHT_YES)
    ...
    private fun setup() {
        ...
        binding.sheetStyleButtonGroup.check(when (dialogStyle) {
    ...
    private fun open() {
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/NareshDhakecha"))
    ...
    private fun share() {
        val sendIntent: Intent = Intent().apply {
            ...
            putExtra(Intent.EXTRA_TEXT,
                "Check out this library! https://github.com/NareshDhakecha")
            type = "text/plain"
        }
